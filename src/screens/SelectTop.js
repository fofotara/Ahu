...
import {SetTopCoordinate} from '../redux/action';
...
const SelectTop = forwardRef(({navigation, route}, ref) => {
  ...
  const saveTopLocationHandler = () => {
    dispatch(SetTopCoordinate(topLocation));
    console.log('saveTopLocationHandler', topLocation);
    navigation.navigate('SelectTim');
  };
        ...
        <>
          <MapView
           ...
           // loadingBackgroundColor="#eeeeee"
            ...
            {/*{marker != null ? <Marker coordinate={marker} key={id++} /> : ''}*/}
          </MapView>
        </>
      )}
